...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_3_assets_index_CDDMKYgk_css from '../admin/dist/assets/index-CDDMKYgk.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_4_assets_index_D9kFHZUa_js from '../admin/dist/assets/index-D9kFHZUa.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-CDDMKYgk.css": { path: A_3_assets_index_CDDMKYgk_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-D9kFHZUa.js": { path: A_4_assets_index_D9kFHZUa_js as unknown as string, mime: "application/javascript; charset=utf-8" },

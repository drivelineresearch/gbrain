...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_3_assets_index_C5fqiUhn_css from '../admin/dist/assets/index-C5fqiUhn.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_4_assets_index_CpyTbkUo_js from '../admin/dist/assets/index-CpyTbkUo.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-C5fqiUhn.css": { path: A_3_assets_index_C5fqiUhn_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-CpyTbkUo.js": { path: A_4_assets_index_CpyTbkUo_js as unknown as string, mime: "application/javascript; charset=utf-8" },
